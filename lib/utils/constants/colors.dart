...
class XColor {
  XColor._(); // restrict unwanted instance creation

  // RGB colors
  static Color backgroundGrey = Colors.grey.shade400;
  static Color foregroundGrey = Colors.grey.shade600;
  ...
  static const Color darkTextColor = Color(0xFF232323);
